...
//     console.log("thread to delete", id)
//     deleteThread(id)
//     .then(res => {
//       setDeleteOpen(false)
...
//         Close
//       </Button>
//         <Button variant="contained" onClick={handleSubmitThread} endIcon={<DeleteIcon />}>
//         Delete thread
//       </Button>
//       </Box>
//         </Box>
...
//         Close
//       </Button>
//         <Button variant="contained" onClick={() => handleDelete(thread.id)} endIcon={<DeleteIcon />}>
//         Delete thread
//       </Button>
//       </Box>
//         </Box>
...
//         <DeleteIcon sx={{cursor: "pointer"}} onClick={() => setDeleteOpen(true)}/>
//       </Box>
//     )}
//   </Card>
// </Grid>
